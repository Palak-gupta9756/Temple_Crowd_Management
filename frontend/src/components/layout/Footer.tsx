      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li><Link href="/temples/somnath"><a className="hover:text-primary transition-colors">Somnath Mahadev</a></Link></li>
              <li><Link href="/temples/dwarka"><a className="hover:text-primary transition-colors">Dwarkadhish</a></Link></li>
              <li><Link href="/temples/ambaji"><a className="hover:text-primary transition-colors">Ambaji Mata</a></Link></li>
              <li><Link href="/temples/pavagadh"><a className="hover:text-primary transition-colors">Pavagadh Shakti Peeth</a></Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-border pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-muted-foreground">
          <p>&copy; 2025 YatraSetu. All rights reserved.</p>
